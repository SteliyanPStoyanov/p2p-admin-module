...
/**
 * Class MarketSecondarySearchRequest
 *
 * @package Modules\Common\Http\Requests
 */
class MarketSecondarySearchRequest extends BaseRequest implements ListSearchInterface
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'discount.from' => 'nullable|numeric',
            'discount.to' => 'nullable|numeric',
            'secondaryMarketFailed' => 'nullable'
        ];
    }
}
