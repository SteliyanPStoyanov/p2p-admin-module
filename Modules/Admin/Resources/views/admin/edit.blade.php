...
@section('content')
    ...
    <div class="row" style="padding-left: 15px;">
        <form method="POST"
              action="{{ route('admin.administrators.update',$admin->administrator_id)}}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" required="required" minlength="2" maxlength="30"
                                       ...
                                       id="middle_name" value="{{$admin->middle_name ?? ''}}">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control"  minlength="2" maxlength="30"
                                    ...
                                    <div class="row collapsing" id="{{$module}}">
                                        @foreach($groups[$role->name] as $key=>$permissions)
                                            <div class="mt-5 col-lg-2">
                                                <div class="w-100">
                                                    <div class="form-check controller-checkbox-style">
