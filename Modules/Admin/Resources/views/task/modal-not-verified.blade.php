    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" >
                <form action="{{ route('admin.tasks.not-verified', $task->getId()) }}" method="POST">
                    {{ admin_csrf_field() }}
                            <div class="mb-3"><b>{{__('common.InvestorNotVerified')}}</b></div>
                            <div class="mb-1">
                                <div class="row">
                            ...
                            <div class="mb-1">
                                <div class="row">
                                    <div class="col-3"><b>{{__('common.InvestorId')}}</b>:</div>
                                    <div class="col-9">
                            ...
                            <div class="mb-1">
                                <div class="row">
                                    <div class="col-3"><b>{{__('common.Status')}}</b>:</div>
                                    <div class="col-9">
